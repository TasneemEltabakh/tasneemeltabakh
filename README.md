<h1 align="center">Hi, I'm <strong>Tasneem Eltabakh</strong></h1>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&color=0D9488&size=24&center=true&vCenter=true&width=620&lines=I+build+backends.;I+wire+up+microservices.;I+ship+data+pipelines.;I+build+reliable+systems.;Fresh+grad%2C+relentless+builder." alt="typing banner" />
</p>

<p align="center">
  Computer &amp; Information Engineering graduate from <strong>Zewail City</strong>.<br/>
  I ship production backends, wire up microservices, and train ML models.<br/>
  Obsessed with clean architecture and the stuff that keeps systems alive under pressure.
</p>
...
class Tasneem(Engineer):
    loves         = ["microservices", "Kafka", "Redis"]
    obsessed_with = "clean architecture"
    believes_in   = "separation of concerns"
    based         = "Giza -> London"
